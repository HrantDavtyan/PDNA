...
# the Modal window, reacting to "Calculate!" click
# stil need to be worked out
# bsModal("calculator", "Calculator", "calculate",
#         wellPanel(
#           numericInput("calc_unit","Measurement unit", min = 0, value = 0),
#           numericInput("calc_quantity", "Quantity",min = 0, value = 0),
#           numericInput("calc_cost","Cost / unit",min = 0, value = 0)
